        ...
        <table align="center" class="container float-center"><tbody><tr><td>
          ...
          <table class="row"><tbody><tr>
            <th class="small-12 large-12 columns first last"><table><tr><th>
              <h4 class="text-center">Your order is placed!</h4>
              <p>Dear <strong>{{ $customer->name }},</strong> 
              <br><br>
                ...
                <table class="row"><tbody><tr>
                  ...
                  <th class="small-12 large-6 columns last"><table><tr><th>
                    <p>
                      ...
                      {{ $shippingType }} ({{ $order->deliveryPeriod() }}) <br>
              ...
              <table>
                <tr height="24px" class="bg-gray"><th valign="middle" class="text-white">Item</th><th valign="middle" class="text-white">Qty</th><th valign="middle" class="text-white">Price</th></tr>
                ...
                @foreach($products as $product)
                  <tr>
                    ...
                    <td>
                      ...
                      Tk {{ (int) $product->pivot->price }}
                      @else 
                      Tk {{ (int) $product->pivot->discounted_price }}
                      @endif
                    </td>
                  </tr>
                @endforeach
                <tr>
                  <td colspan="2" class="text-right pr-5"><b>Sub Total:</b></td>                  
                  <td>Tk {{ (int) $order->total}}</td>
                </tr>
                <tr>
                  <td colspan="2" class="text-right pr-5"><b>Shipping Charge:</b></td>                  
                  <td>Tk {{ (int) $order->shipping_charge}}</td>
                </tr>
                <tr>
                  <td colspan="2" class="text-right pr-5"><b>Coupon Amount:</b></td>                  
                  <td>Tk {{ (int) $coupon->amount}}</td>
                </tr>
                <tr>
                  <td colspan="2" class="text-right pr-5"><b>Net Total:</b></td>                  
                  <td>Tk {{ (int) $order->net_total}}</td>
                </tr>
              </table>
